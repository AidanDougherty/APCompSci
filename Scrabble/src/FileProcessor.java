...
public class FileProcessor {
	...
	private WordWithCountList list = new WordWithCountList();
	static WordWithCountList dictionary = new WordWithCountList();
	private Scanner fileScanner;


	public static void main(String[] args) {
		new FileProcessor().start(dictionary);

	}

	private void start(WordWithCountList ls) {
...
//		}
//		System.out.println("Total Uniqe Words: "+ls.size());
//		System.out.println("Total Words: "+ls.getTotalWords());
//		System.out.println("Word Variance: "+ 100*(double)(ls.size())/(double)(ls.getTotalWords())+"%");
		fileScanner.close();
...
//				}
		try {
			fileScanner = new Scanner(new File("englishWords.txt"));
